...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // Changing 'querySelectorAll' to getElementsByClassName to reduce time to resize pizza
    var randomPizzas =  document.getElementsByClassName("randomPizzaContainer");

    // Moving these variabled declarations outside loop drastically reduces time to resize pizzas
    var i = 0;
